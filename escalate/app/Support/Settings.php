        ...
        return [
            ...
            */
            ...
            'Who can sign up' => [
                ...
                'escalate.admin.confirm_password'    => ['type' => 'bool', 'label' => 'Ask admins for their password again', 'help' => 'Before the admin panel opens, and again every two hours. It is what stops a borrowed or unlocked session reaching the admin area — but it reads as having been signed out, which is why it is off.'],
                'escalate.beta.notify_revoked'       => ['type' => 'bool', 'label' => 'Tell people when their unused invite is released', 'help' => 'Sent only when you take a seat back from somebody who never signed up. It says they are still on the list, which is true — revoking moves them back to the waitlist rather than declining them.'],
